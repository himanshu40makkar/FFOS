...
public class Add_Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add New Item into Menu");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Menu menu=new Menu();
        menu.name=jTextField2.getText();
        menu.price=Integer.parseInt(jTextField3.getText());
        menu.desc=jTextField4.getText();
        menu.order_count=0;
        FFOS.menu.add(menu);
        JOptionPane.showMessageDialog(null,"New Item has Been Added to Menu");
        setVisible(false);
